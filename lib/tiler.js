...
Tiler.prototype.genTile = Promise.method(function (zoomLevel, i, j, next) {
  ...
  // var g = Promise.promisifyAll(gm(readStream));
  ...
  // return gm(readStream).identifyAsync()
  // .then(function (ret) {
  //     console.info(ret);
  // })
  // .catch(function (err) {
  //     console.error(err);
  // });
// console.log('msg', gm.prototype.writeAsync);
  return gm(readStream).writeAsync(util.genFileName(_this.filePath, i, j, zoomLevel));
  // .then(function (res) {
...
console.log('msg', g.writeAsync);
  return g.writeAsync(util.genFileName(_this.filePath, i, j, zoomLevel), function (err) {
